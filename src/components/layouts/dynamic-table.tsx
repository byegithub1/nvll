...
function DynamicTable({ columns, dataSource, nestedColumns, nestedDataSource, primaryKey, footerText, cantBeSearched }: Props) {
  ...
  const getColumnSearchProps = (dataIndex: any) => ({
    filterDropdown: ({ setSelectedKeys, selectedKeys, confirm, clearFilters, close }: any) => (
      <div style={{ padding: 8 }} onKeyDown={(event) => event.stopPropagation()}>
        ...
        />
        <Space>
          <Button onClick={() => handleSearch(selectedKeys, confirm, dataIndex)} icon={<SearchOutlined />} size="small" style={{ width: 90 }}>
            Search
          </Button>
